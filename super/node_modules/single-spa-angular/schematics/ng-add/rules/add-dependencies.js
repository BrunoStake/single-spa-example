...
function addDependencies() {
    ...
    return (tree, context) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        var _a, e_1, _b, _c;
        try {
            for (var _d = true, dependencies_2 = tslib_1.__asyncValues(dependencies), dependencies_2_1; dependencies_2_1 = yield dependencies_2.next(), _a = dependencies_2_1.done, !_a; _d = true) {
